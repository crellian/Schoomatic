...
def reward_kendall_airsim(env):
    speed_kmh = 3.6 * env.previous_state.speed
    return speed_kmh

reward_functions["reward_kendall"] = create_reward_fn(reward_kendall)
reward_functions["reward_kendall_airsim"] = create_reward_fn_airsim(reward_kendall_airsim)
...
def reward_speed_centering_angle_add_airsim(env):
    min_speed = 15.0 # km/h
    max_speed = 25.0 # km/h
...
reward_functions["reward_speed_centering_angle_add_airsim"] = create_reward_fn_airsim(reward_speed_centering_angle_add_airsim)
...
def reward_speed_centering_angle_multiply_airsim(env):
    min_speed = 15.0 # km/h
    max_speed = 25.0 # km/h
...
reward_functions["reward_speed_centering_angle_multiply_airsim"] = create_reward_fn_airsim(reward_speed_centering_angle_multiply_airsim)
